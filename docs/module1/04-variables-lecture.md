...
1. У REPL обчислити та пояснити результати: `7 // 2`, `-7 // 2`, `7 % 3`, `-7 % 3`, `2 ** 0.5`, `int(-3.99)`.
2. Написати програму, яка запитує кількість секунд і виводить її у форматі `H h M min S s` (використати `//` та `%`).
3. Написати програму, яка запитує ім'я, прізвище та рік народження, а виводить: повне ім'я великими літерами, вік і кількість літер у прізвищі. Використати f-рядки.
4. Написати програму обчислення вартості покупки: ціна товару, кількість, знижка у відсотках. Вивести суму без знижки, розмір знижки та кінцеву суму з двома знаками після коми.
5. Пояснити письмово, чому `print(0.1 + 0.2)` виводить `0.30000000000000004`, і як правильно порівнювати дробові числа.
